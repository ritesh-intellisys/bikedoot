...
const SixWheelerGarages = ({ selectedCity, filterData, onGarageClick, onBackToMain, onVehicleTypeChange }) => {
      ...
      <div className="py-20 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-4">Loading six-wheeler garages...</p>
          </div>
        </div>
      </div>
    );
      ...
      <section className="py-8 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400">Find specialized garages for trucks and commercial vehicles</p>
          </div>
            ...
            <div className="lg:col-span-3">
              ...
              {filteredGarages.length === 0 ? (
                <div className="text-center py-12">
                  <p className="text-gray-400 text-lg">No six-wheeler garages found matching your criteria.</p>
                  <button
