...
const ThreeWheelerGarages = ({ selectedCity, filterData, onGarageClick, onBackToMain, onVehicleTypeChange, onShowLoginPopup }) => {
  ...
  // Three-wheeler brands for authorized service centers
  const threeWheelerBrands = [
    'Bajaj', 'TVS', 'Mahindra', 'Piaggio', 'Atul Auto', 'Scooters India',
    'Lohia Auto', 'Champion Motors', 'Force Motors'
  ];
    ...
    const fetchGarages = async () => {
      ...
      try {
        ...
        const requestData = {
          ...
          latitude: lat,
          longitude: lng,
          vehicleType: 'three-wheeler', // Specific vehicle type
        ...
        console.error("Failed to fetch three-wheeler garages:", error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="py-20 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-4">Loading three-wheeler garages...</p>
          </div>
        </div>
      </div>
    );
      ...
      <section className="py-8 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400">Find specialized garages for auto-rickshaws and three-wheelers</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-4">
                  <VehicleTypeSelector 
                    currentVehicleType="three-wheeler"
              ...
              {filteredGarages.length === 0 ? (
                <div className="text-center py-12">
                  <p className="text-gray-400 text-lg">No three-wheeler garages found matching your criteria.</p>
                  <button
...
export default ThreeWheelerGarages;
