...
const FourWheelerGarages = ({ selectedCity, filterData, onGarageClick, onBackToMain, onVehicleTypeChange, onShowLoginPopup }) => {
  ...
  // Four-wheeler brands for authorized service centers
  const fourWheelerBrands = [
    'Maruti Suzuki', 'Hyundai', 'Tata', 'Mahindra', 'Honda', 'Toyota',
    'Ford', 'Volkswagen', 'Skoda', 'Nissan', 'Renault', 'Kia',
    'MG Motor', 'BMW', 'Mercedes-Benz', 'Audi', 'Jaguar', 'Land Rover'
  ];
    ...
    const fetchGarages = async () => {
      ...
      try {
        ...
        const requestData = {
          ...
          latitude: lat,
          longitude: lng,
          vehicleType: 'four-wheeler', // Specific vehicle type
        ...
        console.error("Failed to fetch four-wheeler garages:", error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="py-20 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-4">Loading four-wheeler garages...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Four Wheeler Garages Section */}
      <section className="py-8 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white">
              Four Wheeler Garages Near You
            </h2>
            <p className="text-lg text-gray-400">Find specialized garages for cars and SUVs</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-4">
                  <VehicleTypeSelector 
                    currentVehicleType="four-wheeler"
              ...
              {filteredGarages.length === 0 ? (
                <div className="text-center py-12">
                  <p className="text-gray-400 text-lg">No four-wheeler garages found matching your criteria.</p>
                  <button
...
export default FourWheelerGarages;
