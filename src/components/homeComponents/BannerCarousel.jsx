                ...
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-1.5 sm:gap-2 md:gap-3 justify-center">
                    <button 
                      ...
                      className="bg-gradient-to-r from-red-700 to-red-800 hover:from-red-800 hover:to-red-900 text-white font-semibold py-1.5 px-3 sm:py-2 sm:px-4 md:px-5 rounded-md sm:rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl text-xs sm:text-sm md:text-base"
                    >
                      FIND GARAGES
                    </button>
                    <button className="border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black font-semibold py-1.5 px-3 sm:py-2 sm:px-4 md:px-5 rounded-md sm:rounded-lg transition-colors duration-200 border-2 text-xs sm:text-sm md:text-base">
                      VIEW PRICES
                    </button>
                  </div>
                </div>
